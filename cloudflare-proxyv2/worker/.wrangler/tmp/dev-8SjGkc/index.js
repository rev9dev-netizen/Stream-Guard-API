...
// .wrangler/tmp/bundle-Rw33fG/strip-cf-connecting-ip-header.js
...
// src/index.ts
function decodeUrl(encodedBase64) {
  try {
...
var src_default = {
  async fetch(request, env, ctx) {
    ...
    try {
      const encryptedPath = url.pathname.substring(1);
      if (!encryptedPath) {
      ...
      const apiResponse = await fetch(apiUrl, {
        ...
        headers: {
          ...
          "X-Worker-Proxy": "stream-guard",
          // Identify worker requests
          "Referer": "http://localhost:3000",
          // Add referer for domain validation
...
// .wrangler/tmp/bundle-Rw33fG/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Rw33fG/middleware-loader.entry.ts
