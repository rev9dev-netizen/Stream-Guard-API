...
// .wrangler/tmp/bundle-PTg8ZW/checked-fetch.js
...
// .wrangler/tmp/bundle-PTg8ZW/strip-cf-connecting-ip-header.js
...
var src_default = {
  async fetch(request) {
    ...
    try {
      const tmdbPath = url.pathname.substring(1);
      if (!tmdbPath) {
...
// node_modules/.pnpm/wrangler@3.114.15_@cloudflare+workers-types@4.20251128.0/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// .wrangler/tmp/bundle-PTg8ZW/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-PTg8ZW/middleware-loader.entry.ts
